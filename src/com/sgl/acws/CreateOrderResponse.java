...
public class CreateOrderResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the _return value for this CreateOrderResponse.
     * 
     * @return _return
     */
    ...
    /**
     * Sets the _return value for this CreateOrderResponse.
     * 
     * @param _return
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:acws.sgl.com/AccountCustomerWS", "createOrderResponse"));
